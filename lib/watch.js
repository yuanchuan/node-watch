...
function watch(fpath, options, cb, watcher) {
  ...
  if (is.file(fpath)) {
    ...
    watcher.addWatcher(parent, fs.watch(parent, noRecursive(options), function(evt, fname) {
    ...
    watcher.addWatcher(fpath, fs.watch(fpath, noRecursive(options), function(evt, fname) {
      if (fname) {
